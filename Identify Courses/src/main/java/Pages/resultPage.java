...
public class resultPage extends base {
	...
	private By showMoreIcon = By
			.xpath("//button[@data-track-component='expand_filter_items_button_language']//*[text()='Show more']");
	...
	public void allLanguages() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(applyIcon));
